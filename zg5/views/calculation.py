...
class CalculationWidget(QWidget):
    def __init__(self, zarzadca: ZarzadcaDanych):
        ...
        self.produkt = None
        self.ostatni_wpis_id = None  # przechowuje ID ostatniego wpisu w bazie
        self._setup_ui()
        self.refresh_groups()
    ...
    def oblicz(self):
        ...
        metry_dict = produkt.metry_zgrzewania  # słownik {nazwa_metody: metry}
    ...
    def _wyswietl_wyniki(self, produkt: Produkt):
        ...
        for nazwa, wynik in produkt.wyniki.items():
            ...
            text += f"&nbsp;&nbsp;Metry: {wynik['metry']:.2f} mtr<br>"  # zmiana jednostki
    ...
    def waliduj(self):
        ...
        if ok:
            ...
            # --- Aktualizacja bazy o czas produkcji i odchylenie ---
    ...
    def wypelnij_z_historii(self, dane):
        ...
        if grupa:
            for i, metoda in enumerate(grupa.metody):
                if metoda.nazwa in dane:
                    metry = dane[metoda.nazwa]
                    if metry > 0:
