...
class CalculationWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.metry_table.setHorizontalHeaderLabels(["Metoda", "Metry (m²)", "Wymuś pracowników", "Liczba"])
    ...
    def _wyswietl_wyniki(self, produkt: Produkt):
        ...
        for nazwa, wynik in produkt.wyniki.items():
            ...
            text += f"&nbsp;&nbsp;Metry: {wynik['metry']:.2f} m²<br>"
    ...
    # Aktualizacja tabeli przy zmianie grupy w combobox
